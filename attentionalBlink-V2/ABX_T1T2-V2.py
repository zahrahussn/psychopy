...
win = visual.Window([1024,768],allowGUI=False, monitor='attentionExperimentsMonitor', units='deg', fullscr=True)
...
for thisTrial in trials:
    ...
    dataFile.write('%i %s %s %i %s %s %i\n' %(trials.thisTrial['T2pos'],T1, T1resp, thisResp1, T2, T2resp, thisResp2))
