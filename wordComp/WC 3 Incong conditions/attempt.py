...
#        x1=x1
#    #إجمال
#    if trials.thisTrial.cue=='right' and trials.thisTrial.resp=='different' and trials.thisTrial.cong=='incongMorph' and trials.thisTrial.word in [0,2]:
#        word2_right.pos=[1,0.3] #to draw a vertical line separating the word-halves
#    elif trials.thisTrial.cue=='left' and trials.thisTrial.resp=='same' and trials.thisTrial.cong=='incongMorph' and trials.thisTrial.word in [0,2]:
#        word2_right.pos=[1,0.3] #to draw a vertical line separating the word-halves
#        #مدروس
#    if trials.thisTrial.cue=='right' and trials.thisTrial.resp=='different' and trials.thisTrial.cong=='incongMorph' and trials.thisTrial.word in [0,2]:
#        word2_right.pos=[2.5,0.3] #to draw a vertical line separating the word-halves
#    elif trials.thisTrial.cue=='left' and trials.thisTrial.resp=='same' and trials.thisTrial.cong=='incongMorph' and trials.thisTrial.word in [0,2]:
#        word2_right.pos=[2.5,0.3] #to draw a vertical line separating the word-halves
#
#bottomlist4 words
...
#fanadek
    ...
    if trials.thisTrial.cue=='right' and trials.thisTrial.resp=='different' and trials.thisTrial.cong=='incongControl' and trials.thisTrial.word in [1,3]:
        ...
        word2_right.pos=[0.5,0.5]
#Sa2el
#    if trials.thisTrial.cue=='right' and trials.thisTrial.resp=='different' and trials.thisTrial.cong=='incongControl' and trials.thisTrial.word in [1]:
#        word1_left.pos=[0.5,-1.1]
#    elif trials.thisTrial.cue=='left' and trials.thisTrial.resp=='same' and trials.thisTrial.cong=='incongControl' and trials.thisTrial.word in [1]:
#        word1_left.pos=[0.5,-1.2]
  #Rabi3
...
#
#    else:  #To finish the if loop I just restated the original x position. 
#        x1=x1
