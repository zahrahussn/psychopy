...
params = {'ID number':'1',
	 'frameRate':60,'duration':0.015, 'ISI': 0.075, 'fp': 1,'task':'T2'}
...
dataFile.write('T1, T2, lag, T2resp, correct2\n') 
...
for thisTrial in trials:
    ...
    dataFile.write('%s %s %i %s %i\n' %(T1,trials.thisTrial['T2pres'], trials.thisTrial['T2pos'], T2resp, thisResp2))
