...
fileName = params['ID number']+'_WPTEng2'
...
textFont='Courier'
wordlist1=['goose','horse','prize','angel','vocal','stage']#word list1
wordlist1Form=['moose','house','price','anger','local','stake'] #similar form condition 
wordlist1Cont=['panic','bunch','gloom','truck','green','broom'] #word control condition
...
wordlist2=['brave','freak','giant','value','danger','cheap'] #word list2
wordlist2Form=['brace','creak','grant','valve','dagger','cheat']
wordlist2Cont=['study','point','cover','north','troops','world']
...
for thisTrial in trials: 
    D=numpy.random.random_integers(0,71) #to randomly select one word from list_Dist as distractor
    if D<35:   
    ...
    stim2_D=visual.TextStim(win,font=textFont, text=list_Dist[int(D)], color =(-1,-1,-1),height=stimSize, units='deg')
