...
fileName = params['ID number']+'_SDTEng'
...
textFont='Courier'
wordlist1=['river','chest','chair','power','nation','carrot','alone','master','flower','tutor','space','father']#word list1
wordlist1Form=['rider','crest','chain','tower','notion','parrot','clone','matter','blower','tumor','spice','rather'] #similar form condition 
wordlist1Cont=['knock','moral','slope','habit','member','simple','brush','colony','banana','level','glory','spoons'] #word control condition
