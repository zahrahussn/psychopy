...
subject = 'id13' # alphanumeric subject code - experimenter intials followed by two digits (00, 01, etc)
...
computer='sinistra'
trialsPerCondition=2 # 10 faces x 5 contrasts x 2 reps = 100 trials/block x 4 blocks = 400 trials; changed back to 5 contrasts april 2025
stimDuration = 0.3
stimSize=6
isi= 1
fixate1 = 1.5
...
blank = 1
thumbsize = 4
# contrasts=[0.00025, 0.00054, 0.0012, 0.0025] #0.0003, 0.0009, 0.0016, 0.0028, 0.0050  variance
contrasts=[0.0003, 0.0009, 0.0016, 0.0028, 0.0050] #0.0003, 0.0009, 0.0016, 0.0028, 0.0050  variance
...
fileName = subject+'_'+stimulus+'_'+stimSet+'_day'+str(day)+'_trainingTask'
dataFile = open('../../psychopyData/bias2024/training/'+fileName+'.csv', 'a') 
dataFile.write('computer, block, trial,stimulus,set,stimID,contrast,stimChosen,correct, rt\n')
...
if stimulus=="texture":
    if stimSet=="A":
        ...
        textures=loadmat('stimuli/texturesB.mat')
                        ...
                        if clickedFace==correctFace:
                           ...
                           # blank
                            ...
                            for frameN in range(int(round(blank * frameRate))):
                                ...
                                win.flip()
        dataFile.write(f"{computer}, {blockNumber},{trialNumber},{stimulus},{stimSet},{trials.thisTrial.image+1},{trials.thisTrial.contrast},{clickedFace+1},{accuracy}, {round(RTs[0],2)}\n")
