...
subject = 'zh01' # alphanumeric subject code - experimenter intials followed by two digits (00, 01, etc)
...
fileName = subject+'_'+'training'+'_'+stimulus+'_'+stimSet
dataFile = open('../../psychopyData/bias2024/training/'+fileName+'.csv', 'a') 
dataFile.write('block, trial,stimulus,stimID,contrast,stimChosen,correct, rt\n')
                        ...
                        if clickedFace==correctFace:
                           ...
                           # blank
                            ...
                            for frameN in range(int(round(blank * frameRate))):
                                ...
                                win.flip()
        dataFile.write(f"{blockNumber},{trialNumber},{stimulus},{trials.thisTrial.image+1},{trials.thisTrial.contrast},{clickedFace+1},{accuracy}, {round(RTs[0],2)}\n")
