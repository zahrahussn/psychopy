...
#dlg.addField('Noise type', choices=['fixed', 'variable'])  #3
#dlg.addField('Session number', choices=['1', '2']) #4
#user_input = dlg.show()
#if dlg.OK:
#  print("good to go")
...
fileName = subject+'_'+stimulus+'_'+str(nStim)
dataFile = open(fileName + '.txt', 'w')
dataFile.write('trial\tstimulus\tnStim\tstimID\tsignalInterval\tcontrast\tcorrect\n')

thresholds = subject+'_'+stimulus+'_'+str(nStim)+'_'+'threshold '
...
win = visual.Window([1000, 800], allowGUI=True, monitor=monitor, units='deg', checkTiming=False)
#win.gamma = gamma
