...
function taskOrderLoopBegin(taskOrderLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisTaskOrder of taskOrder) {
...
function LDTaskOrderLoopBegin(LDTaskOrderLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLDTaskOrder of LDTaskOrder) {
...
function LDTrialLoopBegin(LDTrialLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLDTrial of LDTrial) {
...
function SDTaskOrderLoopBegin(SDTaskOrderLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisSDTaskOrder of SDTaskOrder) {
...
function SDPracticeTrialLoopBegin(SDPracticeTrialLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisSDPracticeTrial of SDPracticeTrial) {
...
function SDTRialLoopBegin(SDTRialLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisSDTRial of SDTRial) {
...
function taskOrderCodeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of taskOrderCodeComponents)
...
function innitialCodeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of innitialCodeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function LDInst1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of LDInst1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function LDInst2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of LDInst2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function LDPracticeInstRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of LDPracticeInstComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fixationInstRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fixationInstComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function LDPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of LDPracticeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function LDPRacticeResponseRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of LDPRacticeResponseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function taskInstRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of taskInstComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function LDTaskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of LDTaskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function LDResponse_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of LDResponse_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function LDBreakRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of LDBreakComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SDInitalCodeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SDInitalCodeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SDInst1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SDInst1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SDInst2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SDInst2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SDPracticeInstRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SDPracticeInstComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fixationInst_4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fixationInst_4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SDPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SDPracticeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SDPracticeResponseRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SDPracticeResponseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SDTaskInstRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SDTaskInstComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SDTaskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SDTaskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SDResponseRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SDResponseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SDBreakRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SDBreakComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
